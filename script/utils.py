...
def generate_md_str(DB, list_classif, key, plot_title_fct, bibfile, add_comments=True):
    """
    ...
    for item in list_classif:
        ...
        if str != "":
            ...
            all_in_one_str[plot_title_fct(item)] = str

    return all_in_one_str, outline_list
